  ...
  return (
    <div className="min-h-screen bg-navy-950 text-white">
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold text-white mb-6">About Elite Truck Lines</h1>
      ...
      {/* Values */}
      <section className="border-y border-navy-800 bg-navy-900/30 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-semibold text-white text-center mb-12">What We Stand For</h2>
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto">
        <h2 className="text-2xl font-semibold text-white text-center mb-12">Meet the Team</h2>
        <div className="flex justify-center">
          <div className="bg-navy-900/50 border border-navy-800 rounded-xl p-8 max-w-sm w-full text-center">
            <div className="w-16 h-16 rounded-full bg-accent-500 flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl font-bold text-white">H</span>
            </div>
            <h3 className="text-lg font-semibold text-white mb-1">Hassan</h3>
