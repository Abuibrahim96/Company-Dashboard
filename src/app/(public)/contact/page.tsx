...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-navy-950 text-white px-6 py-20">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <ul className="space-y-6">
            <li className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-navy-400 uppercase tracking-wide mb-0.5">Email</p>
                <a
        ...
        {/* Right — Form */}
        <div className="bg-navy-900/50 border border-navy-800 rounded-xl p-8">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="rounded-lg border border-navy-700 bg-navy-900 text-white px-3 py-2 placeholder:text-navy-400 focus:outline-none focus:ring-2 focus:ring-accent-500 resize-none"
                />
              </div>
