...
const colorMap: Record<string, string> = {
  ...
  valid: "bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/30",
  ...
  invoiced: "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border-yellow-500/30",
  ...
  out_of_service: "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/30",
  inactive: "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/30",
  rejected: "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/30",
};

export default function StatusBadge({ status }: StatusBadgeProps) {
  const colorClass =
    colorMap[status] ?? "bg-navy-200/50 dark:bg-navy-700/50 text-navy-600 dark:text-navy-300 border-navy-300/30 dark:border-navy-600/30";
